...
Tree.prototype.BFSelect = function (filter) {
  ...
  let values = []
  function findValue(nodes, depth) {
    let queue = []

    for (let i = 0; i < nodes.length; i++) {
      if (filter(nodes[i].value, depth)) values.push(nodes[i].value)
...
var leaf6 = branch3.addChild(6);
var leaf7 = branch3.addChild(7);
console.log(root1.BFSelect(function (value, depth) { return value % 2 }))
// [1, 3, 5, 7]
console.log(root1.BFSelect(function (value, depth) { return depth === 1 }))
// [2, 3]
