...
var filter1 = function(value,depth){return value%2;}
var filter2 = function(value,depth){return depth ===1;}

console.log(root1.BFSelect(filter1)); // [1,3,5,7]
console.log(root1.BFSelect(filter2)); // [2,3]
